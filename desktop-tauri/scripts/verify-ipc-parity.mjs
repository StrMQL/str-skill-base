/**
 * Verify IPC channels are declared, routed, and referenced consistently.
 */
...
if (DESKTOP_IPC_CHANNELS.length !== 25) {
  fail(`expected 25 channels, got ${DESKTOP_IPC_CHANNELS.length}`);
}
