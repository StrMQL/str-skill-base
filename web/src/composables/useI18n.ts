...
const zh: Record<string, string> = {
  ...
  'nav.admin': '用户管理',
  'nav.tagAdmin': '标签管理',
  'nav.collectionAdmin': '集合管理',
  'nav.collections': '技能集合',
  'nav.collectionsHint': '精选推荐包',
  'nav.clearCollection': '清除筛选',
  'nav.collectionBack': '返回列表',
  'nav.collectionBrowseHome': '在首页浏览',
  'nav.collectionSkills': '包含技能',
  'nav.collectionLoading': '加载中…',
  'nav.collectionLoadError': '加载失败',
  'nav.collectionEmptySkills': '暂无可见技能',

  // Collections browse pages
  'collections.title': '技能集合',
  'collections.subtitle': '由管理员精心策划的技能推荐包，可以一键批量安装角色需要的数字资产',
  ...
  'collections.backToList': '返回集合列表',
  'collections.creator': '创建者',
  'collections.createdAt': '创建时间',
  'collections.skillCount': '技能数量',
  'collections.coverSkillCount': '{count} 个 skill',
  'collections.downloadCount': '下载次数',
  'collections.installCommand': '批量安装',
  'collections.installHint': '使用 skb 一键安装本集合内全部技能',
  'collections.downloadAll': '下载集合压缩包',
  'collections.downloadAllNone': '没有可下载的技能',
  'collections.sessionExpired': '登录已失效',
  'collections.sessionExpiredDesc': '服务端会话已过期（例如服务重启后）。请重新登录后再查看此集合。',
  'collections.notFound': '集合不存在',
  'collections.notFoundDesc': '未找到该集合，可能已被删除或链接有误。',
  'collections.loadError': '加载失败',
  'collections.loadErrorDesc': '暂时无法获取集合信息，请稍后重试。',
  ...
  'index.collectionsFilter': '集合',
  'index.collectionsFilterHint': '按推荐包浏览',
  'index.clearCollections': '清除集合',
  'index.collectionsShelfTitle': '精选专题',
  'index.collectionsShelfSubtitle': '由管理员精心策划的技能推荐包，支持一键批量安装',
  'index.batchInstall': '一键批量安装',
  'index.copied': '已复制',
  'index.copyCommand': '复制安装命令',
  'index.exitCollection': '退出专题',
  'index.skillsCount': '{count} 个',
  'index.viewCard': '卡片',
  'index.viewList': '列表',
  'index.viewMode': '视图模式',
  'index.noFilterMatch': '没有符合当前筛选条件的 Skill',
  'index.noTagMatch': '没有符合当前标签筛选的 Skill',
  'index.noCollectionMatch': '这个集合里暂无你可见的 Skill',
  'index.noFavoriteMatch': '暂无已收藏的 Skill',
  ...
  'skill.visibilityTitle': '可见性',
  'skill.visibilityHint': 'public 对所有人可见；private 仅所有者/协作者可见。',
  'skill.visibilitySave': '保存可见性',
  'skill.visibilitySaved': '可见性已更新',
  'skill.visibilitySaveFailed': '保存可见性失败',
  ...
  'skill.editSkillDescriptionBtn': '编辑 Skill 介绍',
  'skill.editSkillDescriptionTitle': '编辑 Skill 介绍',
  'skill.editSkillDescriptionLabel': 'Skill 介绍',
  'skill.editSkillDescriptionPlaceholder': '在市场中展示的 Skill 描述...',
  ...
  'publish.visibilityLabel': 'Skill 可见性',
  'publish.visibilityHint': '仅新建 Skill 生效；后续可在详情页修改。',
  'visibility.public': '公开（Public）',
  'visibility.private': '私有（Private）',
  ...
  // Admin - Collection library
  'collectionAdmin.title': '集合管理 - Skill Base',
  'collectionAdmin.heading': '集合 / 推荐包',
  'collectionAdmin.subtitle': '// 维护部门、岗位或场景的推荐 Skill 入口',
  'collectionAdmin.listHeading': '全部集合',
  'collectionAdmin.addCollection': '新建集合',
  'collectionAdmin.searchPlaceholder': '搜索集合名...',
  'collectionAdmin.thName': '名称',
  'collectionAdmin.thSlug': '英文名',
  'collectionAdmin.thDescription': '说明',
  'collectionAdmin.thSkills': 'Skill 数',
  'collectionAdmin.thSort': '排序',
  'collectionAdmin.thActions': '操作',
  'collectionAdmin.emptyState': '暂无集合',
  'collectionAdmin.fetchError': '加载集合失败',
  'collectionAdmin.addModal': '新建集合',
  'collectionAdmin.editModal': '编辑集合',
  'collectionAdmin.namePlaceholder': '集合名称',
  'collectionAdmin.slugPlaceholder': 'frontend-essentials',
  'collectionAdmin.slugHint': '小写字母开头，仅含小写字母、数字和连字符；用于下载文件名与 skb 安装 key，不可重复',
  'collectionAdmin.slugRequired': '请输入英文名',
  'collectionAdmin.slugInvalid': '英文名格式无效：需小写字母开头，仅含小写字母、数字和连字符',
  'collectionAdmin.descriptionPlaceholder': '适用人群、维护说明...',
  'collectionAdmin.descriptionMaxHint': '说明会显示在封面，最多 {max} 字、3 行',
  'collectionAdmin.descriptionTooLong': '集合说明不能超过 {max} 字',
  'collectionAdmin.nameRequired': '请输入集合名称',
  'collectionAdmin.addSuccess': '集合已创建',
  'collectionAdmin.editSuccess': '集合已更新',
  'collectionAdmin.saveError': '保存失败',
  'collectionAdmin.deleteConfirm': '确定删除集合「{name}」吗？只会移除集合，不会删除 Skill。',
  'collectionAdmin.deleteSuccess': '集合已删除',
  'collectionAdmin.deleteError': '删除失败',
  'collectionAdmin.editMembers': '维护成员',
  'collectionAdmin.membersModal': '维护集合成员',
  'collectionAdmin.skillSearchPlaceholder': '按 Skill 名称或 ID 筛选...',
  'collectionAdmin.noSkills': '暂无 Skill',
  'collectionAdmin.membersLoadError': '加载成员失败',
  'collectionAdmin.membersSaveSuccess': '集合成员已保存',
  'collectionAdmin.membersSaveError': '保存成员失败',
  'collectionAdmin.maxSkillsHint': '每个集合最多 10 个 Skill',
  'collectionAdmin.maxSkillsExceeded': '集合最多只能包含 10 个 Skill',
...
const en: Record<string, string> = {
  ...
  'nav.tagAdmin': 'Tags',
  'nav.collectionAdmin': 'Collections',
  'nav.collections': 'Collections',
  'nav.collectionsHint': 'Curated skill packs',
  'nav.clearCollection': 'Clear filter',
  'nav.collectionBack': 'Back to list',
  'nav.collectionBrowseHome': 'Browse on home',
  'nav.collectionSkills': 'Skills',
  'nav.collectionLoading': 'Loading…',
  'nav.collectionLoadError': 'Failed to load',
  'nav.collectionEmptySkills': 'No visible skills',

  // Collections browse pages
  'collections.title': 'Collections',
  'collections.subtitle': 'Curated skill recommendation packs by administrators, can be installed by roles at once',
  ...
  'collections.creator': 'Created by',
  'collections.createdAt': 'Created',
  'collections.skillCount': 'Skills',
  'collections.coverSkillCount': '{count} skills',
  'collections.downloadCount': 'Downloads',
  'collections.installCommand': 'Batch install',
  'collections.installHint': 'Install all skills in this collection with skb',
  'collections.downloadAll': 'Download collection zip',
  'collections.downloadAllNone': 'No downloadable skills',
  'collections.sessionExpired': 'Session Expired',
  'collections.sessionExpiredDesc': 'Your session has expired (for example after a server restart). Please sign in again to view this collection.',
  'collections.notFound': 'Collection Not Found',
  'collections.notFoundDesc': 'This collection does not exist. It may have been removed or the link is incorrect.',
  'collections.loadError': 'Failed to Load',
  'collections.loadErrorDesc': 'Could not load this collection right now. Please try again later.',
  ...
  'index.collectionsFilter': 'Collections',
  'index.collectionsFilterHint': 'Browse recommended packs',
  'index.clearCollections': 'Clear collection',
  'index.collectionsShelfTitle': 'Featured Collections',
  'index.collectionsShelfSubtitle': 'Curated skill recommendation packs by administrators, supporting one-click batch installation',
  'index.batchInstall': 'Batch Install',
  'index.copied': 'Copied',
  'index.copyCommand': 'Copy Command',
  'index.exitCollection': 'Exit Collection',
  'index.skillsCount': '{count}',
  'index.viewCard': 'Cards',
  'index.viewList': 'List',
  'index.viewMode': 'View mode',
  'index.noFilterMatch': 'No skills match the current filters',
  'index.noTagMatch': 'No skills match the selected tags',
  'index.noCollectionMatch': 'No visible skills in this collection',
  'index.noFavoriteMatch': 'No favorited skills yet',
  ...
  'skill.visibilityTitle': 'Visibility',
  'skill.visibilityHint': 'Public is visible to everyone; private is only visible to owners/collaborators.',
  'skill.visibilitySave': 'Save visibility',
  'skill.visibilitySaved': 'Visibility updated',
  'skill.visibilitySaveFailed': 'Failed to save visibility',
  ...
  'skill.editSkillDescriptionBtn': 'Edit skill description',
  'skill.editSkillDescriptionTitle': 'Edit skill description',
  'skill.editSkillDescriptionLabel': 'Skill description',
  'skill.editSkillDescriptionPlaceholder': 'Description shown in the marketplace...',
  ...
  'publish.visibilityLabel': 'Skill visibility',
  'publish.visibilityHint': 'Only applied when creating a new skill; editable later on detail page.',
  ...
  // Admin - Collection library
  'collectionAdmin.title': 'Collections - Skill Base',
  'collectionAdmin.heading': 'Collections / Packs',
  'collectionAdmin.subtitle': '// Maintain recommended Skill entry points for teams, roles, or scenarios',
  'collectionAdmin.listHeading': 'All collections',
  'collectionAdmin.addCollection': 'New collection',
  'collectionAdmin.searchPlaceholder': 'Search collections...',
  'collectionAdmin.thName': 'Name',
  'collectionAdmin.thSlug': 'Slug',
  'collectionAdmin.thDescription': 'Description',
  'collectionAdmin.thSkills': 'Skills',
  'collectionAdmin.thSort': 'Sort',
  'collectionAdmin.thActions': 'Actions',
  'collectionAdmin.emptyState': 'No collections yet',
  'collectionAdmin.fetchError': 'Failed to load collections',
  'collectionAdmin.addModal': 'New collection',
  'collectionAdmin.editModal': 'Edit collection',
  'collectionAdmin.namePlaceholder': 'Collection name',
  'collectionAdmin.slugPlaceholder': 'frontend-essentials',
  'collectionAdmin.slugHint': 'Lowercase letter first; letters, numbers, and hyphens only. Used for download filename and skb install key. Must be unique.',
  'collectionAdmin.slugRequired': 'Slug is required',
  'collectionAdmin.slugInvalid': 'Invalid slug: must start with a lowercase letter and contain only lowercase letters, numbers, and hyphens',
  'collectionAdmin.descriptionPlaceholder': 'Audience or maintainer notes...',
  'collectionAdmin.descriptionMaxHint': 'Shown on the cover; up to {max} characters, 3 lines',
  'collectionAdmin.descriptionTooLong': 'Description cannot exceed {max} characters',
  'collectionAdmin.nameRequired': 'Collection name is required',
  'collectionAdmin.addSuccess': 'Collection created',
  'collectionAdmin.editSuccess': 'Collection updated',
  'collectionAdmin.saveError': 'Failed to save',
  'collectionAdmin.deleteConfirm': 'Delete collection "{name}"? This only removes the collection, not its skills.',
  'collectionAdmin.deleteSuccess': 'Collection deleted',
  'collectionAdmin.deleteError': 'Failed to delete collection',
  'collectionAdmin.editMembers': 'Edit members',
  'collectionAdmin.membersModal': 'Edit collection members',
  'collectionAdmin.skillSearchPlaceholder': 'Filter by Skill name or ID...',
  'collectionAdmin.noSkills': 'No skills yet',
  'collectionAdmin.membersLoadError': 'Failed to load members',
  'collectionAdmin.membersSaveSuccess': 'Collection members saved',
  'collectionAdmin.membersSaveError': 'Failed to save members',
  'collectionAdmin.maxSkillsHint': 'Each collection can contain at most 10 skills',
  'collectionAdmin.maxSkillsExceeded': 'A collection can contain at most 10 skills',
